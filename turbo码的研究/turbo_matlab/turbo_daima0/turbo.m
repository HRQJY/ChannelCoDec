...
%%%%%%%%%%%%%%%%%step 1 %%%%%%%%%%%%%%%%%%%
k=1;                 % m'=0,m=0,8  k=1~8;
i=1;gama(k,9,1)=0.5*gau(x(k),y(k),1);          %i=1,m=8
i=0;gama(k,1,2)=0.5*gau(x(k),y(k),0);          %i=0,m=0
alpha(k,9,1)=2*gama(k,9,1)/((gama(k,9,1)+gama(k,1,2))*2);                       %i=1;
alpha(k,1,2)=2*gama(k,1,2)/((gama(k,9,1)+gama(k,1,2))*2);                         %i=0
%%%%%%%%%%%%%%%%%step 2 %%%%%%%%%%%%%%%%%%%
