...
for k=1:L_seq
    ...
    if k==L_seq
        ...
        lanbda1=a(:,k)+b(([4 0 1 5 6 2 3 7]+1),k+1)+[d(1,k);d(1,k);d(2,k);d(2,k);d(2,k);d(2,k);d(1,k);d(1,k)];
        lanbda0=a(:,k)+b(([0 4 5 1 2 6 7 3]+1),k+1)-[d(1,k);d(1,k);d(2,k);d(2,k);d(2,k);d(2,k);d(1,k);d(1,k)];
        llr(k)=max(lanbda1)-max(lanbda0);
    end
end
